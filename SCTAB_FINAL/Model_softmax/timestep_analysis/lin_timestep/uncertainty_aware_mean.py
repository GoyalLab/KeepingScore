...
def softmax_posterior_latent(
    ...
    Now designed for class mean embeddings.
    
    Args:
        T_train: Number of timesteps used during training
        T_eval: Number of timesteps to use for evaluation (subsampled from T_train)
    ...
    z_path_expanded = z_path.repeat(num_classes, 1, 1)            # [num_classes*n_paths, T_eval+1, D]
