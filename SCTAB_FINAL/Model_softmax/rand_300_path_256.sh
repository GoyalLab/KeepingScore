...
#SBATCH --output=logs/rand_300_T_1000_Path_256/slurm-%j.out
#SBATCH --error=logs/rand_300_T_1000_Path_256/slurm-%j.err
...
# Run script
/projects/b1042/GoyalLab/jaekj/python/scTAB/bin/python -u rand_300_path_256.py \
    ...
    --n_paths 256 \
    --sample_size 300 \
    --save_dir "./Rand_300_T_1000_Path_256" \
